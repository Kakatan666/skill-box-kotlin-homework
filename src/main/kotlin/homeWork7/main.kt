...
Каналы представлены строками с названием.
...
fun main() {
    val lg = TV("LG", "CORPA14", 14.2)
    val samsung = TV("SAMSUNG", "ABOBUS30", 30.0)
    val massimo = TV("MASSIMO", "BIG-CLADIO-88", 88.14)
...
fun printInfo(tv: TV) {
    ...
    tv.turnOff()
    tv.printStatus()
    tv.switchToChannel(4)
    tv.printStatus()
    tv.getChannelList()
    tv.printCurrentVolume()
    tv.volumeUp(20)
    tv.printCurrentVolume()
    tv.volumeDown(40)
    tv.printCurrentVolume()
